window.onload = function()
{
    ...
    function gameOver()
    {
        ...
        contexte.fillText("You are Dead !", canvasWidth/2-canvasWidth/5.5, canvasHeight/2.25);
        ...
        {   
            ...
            else
            {
                ...
                contexte.fillText("Appuyer sur la barre d'espace pour recommencer", canvasWidth/3.5 , canvasHeight/1.15);
            }
        }
        else
        {
    ...
    function affichageBoost()
    {
        ...
        contexte.font = "20px serif";
            if(bulletTimeOn)
            {
                contexte.fillText("Nb de charges de Bullet Time : " + nombreChargesReel.toString(), 632 , canvasHeight-5);
                contexte.restore();
            }
            else
            {
    ...
    function Pomme(position)
    {
        ...
        function lancerCompteur(tempsProg, duree)
            {          
                temps = tempsProg;
        ...
        function affichercompteur()
        {
            contexte.save();
            contexte.font = "20px serif";
            texte = contexte.fillText("Compteur Boost : " + (Math.round((temps) *10)/10).toString(), 700 , canvasHeight-285);
            contexte.restore();
        ...
        document.onkeydown = function handleKeydown(e)
        {
            ...
            switch(key)
            {
                ...
                case 17:
                    ...
                    {
                        if(revCompteurOn === false)
                        {
                            bulletTime();
                            bulletTimeOn = true;
                        }
                    }
                    else if(compteurOn === false)
                    {
                        boost();
                    }
                    return;
